...
export default function Accordion({ title, children }) {
  ...
  return (
    <div className="">
      <button className={`flex items-center justify-between w-full pl-4 pr-[24px] py-[12px] sm:py-[24px] text-left text-[24px] font-medium text-white focus:outline-none border-b border-[#444444] first:border-t-0`} onClick={toggleAccordion}>
        ...
        <svg className={`transform transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} width={35} height={35} viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path opacity={0.1} fillRule="evenodd" clipRule="evenodd" d="M0 17.5C0 7.83502 7.83502 0 17.5 0C27.165 0 35 7.83502 35 17.5C35 27.165 27.165 35 17.5 35C7.83502 35 0 27.165 0 17.5Z" fill="white" />
          <mask
            id="mask0_223_607"
            style={{
              maskType: 'alpha'
