...
export default function PostSingleDetails() {
  ...
  return (
    <div className="">
      <div className="mx-auto max-w-[1100px] pt-[120px] px-4">
        <h3 className="text-white mt-[20px] uppercase line-clamp-3 mx-auto max-w-[900px] !leading-0 !text-2xl sm:!text-3xl text-center body-text leading-7">{post.title}</h3>
        <img src={post.imageUrl} className="rounded-[13px] border border-white/50 w-full mt-[48px]" alt="single-post-img" />
