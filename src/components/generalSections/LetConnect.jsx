...
export default function LetConnect() {
  return (
    <div className="mt-[100px] py-[40px] sm:py-[0px] relative overflow-hidden">
      <div className="w-full min-h-[270px] sm:min-h-[434px] flex flex-col items-center justify-center px-4 sm:px-5 relative overflow-hidden">
        ...
        <div className="mx-auto flex relative z-10 flex-col items-center max-w-[407px] min-h-[189px]">
          ...
          <Link
            to=""
            className={`h-[51px] w-[166px] font-['AdventPro-Medium'] gradient-background rounded-2xl text-[white] cursor-pointer transition-[background-color] duration-[0.3s] md:flex items-center justify-center gap-2 tracking-[-0.3px] leading-[23.25px] font-medium text-[16px] px-5 py-2.5 mt-5 flex`}
            // style={{
            //   backgroundImage:
