    ...
    content: (
      <div className="w-full flex flex-col-reverse md:flex-row items-center gap-[32px]">
        ...
        <div className="w-full min-h-[278px] flex-col justify-start items-start gap-4 flex">
          ...
          <Link to="" className={`h-[54px] w-[141px] gradient-background rounded-[50px] text-[white] cursor-pointer transition-[background-color] duration-[0.3s] flex items-center justify-center gap-2 tracking-[-0.3px] leading-[23.25px] font-medium text-[15px] px-5 py-2.5 mt-4`}>
