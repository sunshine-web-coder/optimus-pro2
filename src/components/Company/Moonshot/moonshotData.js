export const roadmapData = [
  {
    phase: '2017 - 2020',
    title: 'Experience Pain Points',
    items: ['Lost significant funds due to pain points', 'Talked with people with similar experience', 'Conceptualization of solution']
  },
  {
    phase: '2021',
    title: 'Ideation',
    items: ['Defined project purpose and goals', 'Brainstorm, research and document solutions', 'Launch a platform to educate people']
  },
  {
    phase: '2022',
    title: 'Team & Community Building',
    items: ['Build a small team to kickstart our project', 'Launch our MVC (Minimum Viable Community)', 'Start training and upskilling our team']
  },
  {
    phase: '2023',
    title: 'Brand Launch',
    items: ['Launch and incorporate Optimus PRO brand', 'Launch brand awareness campaigns', 'Establish strategic partnerships and collaboration']
  },
  {
    phase: '2024',
